...
const DropdownMenu: React.FC<DropdownMenuProps> = ({ attendees, index, setLine }) => {
  ...
  return (
    <ul className="text-sm text-white/85 flex flex-col z-50 border border-solid border-white/10 rounded-lg max-w-32 absolute top-7 bg-zinc-900">
      ...
      <li>
        <button className="flex items-center gap-2 group p-3  border-solid border-white/10 hover:cursor-pointer ">
